...
namespace FMS_Collection.Application.Services
{
    public class DocumentService
    {
        ...
        public DocumentService(IDocumentRepository repository, AzureBlobService blobService, AssetService assetService, IHostEnvironment env)
        {
        ...
        public async Task<ServiceResponse<List<Documents>>> GetAllDocumentsAsync()
        {
        ...
        public async Task<ServiceResponse<List<DocumentListResponse>>> GetDocumentListAsync(Guid userId)
        {
            ...
            foreach (var item in response.Data)
            {
                ...
                if (item.OriginalPath.EndsWith(".pdf"))
                {
                    var path = Path.Combine(_env.ContentRootPath, "StaticFiles", "pdf.png");
                    item.ThumbnailPathSasUrl = path;
                    item.ThumbnailPath = "";
                }
